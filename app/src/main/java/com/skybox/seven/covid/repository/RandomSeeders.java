...
public class RandomSeeders {
    ...
    public static List<Advice> setUpAdvice() {
        ...
        adviceList.add(new Advice(1,1,"Wash your hands", "Regularly and thoroughly clean your hands with an alcohol-based hand rub or wash them with soap and water.",
        ...
        adviceList.add(new Advice(2,1,"Social distancing","Maintain at least 1 metre (3 feet) distance between yourself and others.",
        ...
        adviceList.add(new Advice(3,1,"Avoid going to crowded places.", "Avoid going to crowded places.",
                ...
                R.drawable.ic_wash_hands));
        adviceList.add(new Advice(4,1,"Avoid touching eyes, nose and mouth.","Avoid touching eyes, nose and mouth.",
                ...
                R.drawable.ic_wash_hands));
        adviceList.add(new Advice(5,1,"Make sure you, and the people around you, follow good respiratory hygiene.",
                ...
                R.drawable.ic_wash_hands));
        adviceList.add(new Advice(6,1,"Stay home and self-isolate",
                ...
                R.drawable.ic_wash_hands));
        adviceList.add(new Advice(7,1,"seek medical attention",
                ...
                R.drawable.ic_wash_hands));
        adviceList.add(new Advice(8,1,"Keep up to date",
