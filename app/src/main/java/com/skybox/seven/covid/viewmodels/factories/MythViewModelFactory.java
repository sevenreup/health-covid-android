...
public class MythViewModelFactory implements ViewModelProvider.Factory {
    ...
    public MythViewModelFactory(MythRepository mythRepository, Context context) {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new MythViewModel(mythRepository, new SharedPreferenceRepository(context.getSharedPreferences(context.getString(R.string.shared_preference_key), Context.MODE_PRIVATE)));
    }
}
