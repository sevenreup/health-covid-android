    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_OVERLAY).setFilter(filter).build(Location.this);
        ...
        saveLocation.setOnClickListener(v -> {
            ...
            if(selectedLoc != null ){
                ...
                Toast.makeText(Location.this,"Please set location", Toast.LENGTH_LONG).show();
            }
        });
